...
class QYLOG_INFO
{
	private:
		/* 日志常量 */
		static const auto LOG_INFO_SUCCESS = 11;	//信息(成功)		深紫罗兰的蓝色(BlueViolet)	14822282  #8A2BE2  RGB(138,43,226)
		static const auto LOG_INFO_FAIL = 12;		//信息(失败)		棕色(Brown)					2763429   #A52A2A  RGB(165,42,42)
		static const auto LOG_INFO_RECEIVE = 13;	//信息(接收)		纯蓝(Blue)					16711680  #0000FF  RGB(0,0,255)
		static const auto LOG_INFO_SEND = 14;		//信息(发送)		纯绿(Green)					32768     #008000  RGB(0,128,0)

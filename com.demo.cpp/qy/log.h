...
{	
	private:
		/* 日志常量 */
		static const auto LOG_DEBUG = 0;			//调试			暗淡的灰色(DimGray)			6908265   #696969  RGB(105,105,105)
		static const auto LOG_INFO = 10;			//信息			纯黑(Black)					0         #000000  RGB(0,0,0)
		static const auto LOG_WARNING = 20;			//警告			深橙色(DarkOrange)			36095     #FF8C00  RGB(255,140,0)
		static const auto LOG_ERROR = 30;			//错误			深粉色(DeepPink)				9639167   #FF1493  RGB(255,20,147)
		static const auto LOG_FATAL = 40;			//致命错误		纯红(Red)					255       #FF0000  RGB(255,0,0)
